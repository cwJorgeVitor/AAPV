...
const consultas = document.querySelector('#consultas'),
      ...
      meuperfil2 = document.querySelector('#meuperfil2'),
      ...
      content_myprofile2 = document.querySelector('#my_profile2'),
      ...
      consultas.addEventListener('click', ()=>{
          ...
          content_myprofile2.style.display = 'none'
    ...
    meuperfil2.addEventListener('click', ()=>{
        content_myprofile.style.display = 'none'
        content_myprofile2.style.display = 'block'
        content_consultas.style.display = 'none'
        content_agendamento.style.display = 'none'
    })
